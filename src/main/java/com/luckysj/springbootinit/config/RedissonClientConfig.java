 ...
 */
@Configuration
@EnableConfigurationProperties(RedissonCientConfigProperties.class)
public class RedissonClientConfig {

    @Bean("redissonClient")
    public RedissonClient redissonClient(ConfigurableApplicationContext applicationContext, RedissonCientConfigProperties properties) {
