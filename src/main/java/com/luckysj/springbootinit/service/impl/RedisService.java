package com.luckysj.springbootinit.service.impl;
...
public class RedisService {
     ...
     * 获取计数总数
     */
    public Long getCountSize(String key) {
    ...
    /**
     * 设置指定 key且带有存活时间的值 (String, S)
     */
    public void setStringTime(String key, String value, Long time, TimeUnit unit) {
    ...
    /**
     * 设置指定 key 的值 (Object) 和保存时间 (单位秒)
     */
    public <T> void setObject(String key, T value, Long seconds) {
        setObject(key, value);
