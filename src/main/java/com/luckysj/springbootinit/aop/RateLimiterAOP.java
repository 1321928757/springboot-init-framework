package com.luckysj.springbootinit.aop;


import com.luckysj.springbootinit.annotation.AccessInterceptor;
import com.luckysj.springbootinit.utils.IPUtils;
...
public class RateLimiterAOP {
    ...
    // 限流RateLimiter缓存前缀
    private static final String rateLimiterName = "luckysj:RateLimiter:";
    // 黑名单缓存前缀
    private static final String blacklistPrefix = "luckysj:RateBlockList:";
    ...
    public Object doRouter(ProceedingJoinPoint jp, AccessInterceptor accessInterceptor) throws Throwable {
        ...
        // 获取限流器 -> Redisson RRateLimiter 1分钟过期
        ...
        if (!rateLimiter.tryAcquire()) {
            if (accessInterceptor.blacklistCount() != 0) {
                ...
                atomicLong.expire(24, TimeUnit.HOURS); //设置黑名单原子计数器器过期时间为24小时
            }
